...
export const metadata: Metadata = {
  ...
  description:
    "Celebrate Ganesh Chaturthi with premium sparklers, aerial cakes, and gift combos from A Mercury Crackers. Wholesale rates, child-safe quality, delivery all over Bareilly.",
};
